...
class SnakeGameWindow(QMainWindow):
    def __init__(self):
        ...
        self.start_button = QPushButton("Jugar", self)
        self.start_button.clicked.connect(self.start_game)
        self.layout.addWidget(self.start_button)

        self.leaderboard_button = QPushButton("Mejores Jugadores", self)
        self.leaderboard_button.clicked.connect(self.show_leaderboard)
        self.layout.addWidget(self.leaderboard_button)

        self.timer = QTimer(self)
        self.timer.timeout.connect(self.update_frame)
        self.timer.start(10)  # Actualiza cada 10 ms (100 FPS)
        ...
        # Limite de recuadros de serpiente visibles
        self.max_snake_boxes = 3
    ...
    def start_game(self):
        ...
        self.leaderboard_button.setEnabled(False)
        self.snake = [(5, 5)]
        self.food = self.generate_food()
        self.score = 0

    def show_leaderboard(self):
        # Mostrar la pantalla de mejores jugadores (a implementar)
        pass
    ...
    def update_frame(self):
        ...
        if self.game_started:
            ...
            if results.multi_hand_landmarks:
                ...
                # Limita la longitud de la serpiente en proporción al puntaje
                while len(self.snake) > self.score + 1:
                    # Elimina las ubicaciones anteriores
                    self.snake.pop()
                ...
                # Limita el número de recuadros de serpiente visibles
                while len(self.trail) > self.max_snake_boxes:
                    self.trail.pop(0)
